...
impl Interpreter {
    ...
    /*
    pub fn gcd(a: u64, b: u64) -> u64 { // Euclidean algorithm
        match b {
    ...
    */
    ...
    pub fn gcd(mut u: u64, mut v: u64) -> u64 { // binary algorithm
        use std::cmp::min;
        use std::mem::swap;
        ...
        loop {
            ...
            // shift by k is necessary to add back the 2ᵏ factor that was
